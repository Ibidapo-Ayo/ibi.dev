...
const IntroCard = () => {
  return (
    <div className='space-y-4'>
     ...
     <p className='resumeText'> In the past, I worked as a Frontend Developer at <Linker text='Beadaut' link='https://www.beadaut.com' />, where I contributed to building an AI-powered platform for personalized learning. This experience allowed me to combine cutting-edge technology with intuitive, user-friendly interfaces, delivering solutions that enhanced user engagement and learning outcomes. My background spans diverse environments, from startups to established organizations, equipping me with the versatility to tackle complex challenges and drive impactful results.</p>
